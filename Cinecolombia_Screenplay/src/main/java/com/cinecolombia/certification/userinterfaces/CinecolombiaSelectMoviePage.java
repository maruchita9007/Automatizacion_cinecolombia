...
public class CinecolombiaSelectMoviePage {
	...
	public static final Target CINECOLOMBIA_COOKIE = Target.the("Cinecolombia cookie popup button").locatedBy("/html/body/div[1]/div/a[1]");
	...
	public static final Target CINECOLOMBIA_SELECT_DATE = Target.the("Cinecolombia select date").locatedBy("/html[1]/body[1]/div[11]/table[1]/tbody[1]/tr[5]/td[{0}]/a[1]");
